...
def run_probe_experiment(
    ...
    df = run_probe(
        ...
        device=device,
        min_layer=min_layer,
        show_tokens=show_probe_tokens,
        show_count=show_probe_count,
        show_vector=show_probe_vector,
        show_vector_layer=show_probe_vector_layer,
        show_examples=show_probe_examples,
        show_examples_count=show_probe_examples_count,
        show_embedding_table=show_embedding_table,
        show_embedding_table_rows=show_embedding_table_rows,
        show_embedding_table_dims=show_embedding_table_dims,
